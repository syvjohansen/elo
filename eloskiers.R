...
malelast_race <- maleelodf[maleelodf$maledate=="20200500",]
...
ladylast_race <- ladyelodf[ladyelodf$ladydate=="20200500", ]
...
actmalelast_race <- actmaleelodf[actmaleelodf$maledate=="20200500",]
...
actladylast_race <- actladyelodf[actladyelodf$ladydate=="20200500",]
...
#maleseasonstandings[maleseasonstandings$maledate=="20200500", ]
...
ladyseasonstandings[ladyseasonstandings$ladydate=="20200500", ]
