...
refdf = pd.read_pickle("~/ski/elo/python/ski/ladieselodf2.pkl")
	#print(refdf)
...
#print(refdf["id"])
#print(df['id'])
df.to_pickle("~/ski/elo/python/ski/ladiesupdate.pkl")
df.to_excel("~/ski/elo/python/ski/ladiesupdate.xlsx")
