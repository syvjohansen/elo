...
refdf = pd.read_pickle("~/ski/elo/python/biathlon/menelodf2.pkl")
	#print(refdf)
...
df = setup()
df = elo(refdf, df)
df.to_pickle("~/ski/elo/python/biathlon/menupdate.pkl")
df.to_excel("~/ski/elo/python/biathlon/menupdate.xlsx")
