...
refdf2 = pd.read_pickle("~/ski/elo/python/biathlon/men/varmen.pkl")
#refdf2 = pd.read_pickle("~/ski/elo/python/biathlon/men/varmen_distance.pkl")
#refdf2 = pd.read_pickle("~/ski/elo/python/biathlon/men/varmen_all.pkl")
#refdf2 = pd.read_pickle("~/ski/elo/python/biathlon/men/varmen_sprint.pkl")
refdf2 = refdf2.loc[refdf2['season']==2021]
...
df = pd.DataFrame(d)
df.to_excel("~/ski/elo/python/biathlon/winprob/varmenwinprob.xlsx")
