...
bmlast_race <- bmalebelodf[bmalebelodf$bmdate=="20150500",]
...
bllast_race <- bladybelodf[bladybelodf$bldate=="20200500",]
...
actbmlast_race <- actbmalebelodf[actbmalebelodf$bmdate=="20200500",]
...
actbllast_race <- actbladybelodf[actbladybelodf$bldate=="20200500",]
...
bmseasonstandings[bmseasonstandings$bmdate=="20200500", ]
...
blseasonstandings[blseasonstandings$bldate=="20200500", ]
